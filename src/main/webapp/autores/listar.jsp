...
<head>
    ...
    <style>
        ...
        .boton-nuevo { display: inline-block; margin-bottom: 20px; background-color: #2980b9; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px; transition: background-color 0.3s ease; }
        .boton-nuevo:hover { background-color: #1abc9c; }
            ...
            <c:forEach var="a" items="${autores}">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="AutorServlet?action=eliminar&id=${a.id}" class="accion" onclick="return confirm('¿Eliminar este autor?')">🗑️ Eliminar</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
